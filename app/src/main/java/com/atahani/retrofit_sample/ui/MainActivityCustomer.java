...
public class MainActivityCustomer extends AppCompatActivity {
    ...
    private DataAdapterCustomer mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new DataAdapterCustomer(this, new DataAdapterCustomer.DataEventHandler() {
            @Override
            public void onEditData(String Id, int position) {
                //start activity to edit
                Intent editIntent = new Intent(getBaseContext(), CreateOrEditCustumer.class);
            ...
            public void onDeleteData(String Id, final int position) {
                Call<CustomerModel> call = mTService.deleteCustomerById(Id);
                //async request
            ...
            public void onDetailData(String Id, int position) {
                Intent detailIntent = new Intent(getBaseContext(), CreateOrEditCustumer.class);
    ...
    private void getCustomerFromServer() {
        Call<List<CustomerModel>> call = mTService.getCustomer();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_add) {
            ...
            Intent postNewIntent = new Intent(this, CreateOrEditCustumer.class);
